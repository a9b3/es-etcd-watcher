...
exports.default = function () {
  var _ref4 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(_ref3) {
    var _this = this;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            console.log('connecting etcd with configurations ' + (0, _stringify2.default)(etcdConfigs));
            esEtcd = new _esEtcd2.default(etcdConfigs);

            // For each key specified in config file, set up the etcd watcher

            config.keys.forEach(function () {
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 7:
                        ...
                        _context3.next = 12;
                        return _context3.t0[_context3.t1].call(_context3.t0, _context3.t4);
                      ...
                      case 20:
                        ...
                        esEtcd.watch(key, function () {
                          var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(changed) {
                            var _i;
                              ...
                              while (1) {
                                switch (_context2.prev = _context2.next) {
                                  ...
                                  case 1:
                                    ...
                                    if (!(commands[_i].constructor === Function)) {
                                      _context2.next = 15;
                                      break;
                                    }
                                  ...
                                  case 7:
                                    ...
                                    _context2.t3 = changed;
                                    _context2.t4 = api;
                                    _context2.t5 = {
                                      root: _context2.t2,
                                      changed: _context2.t3,
                                      api: _context2.t4
                                    };
                                    _context2.next = 13;
                                  ...
                                  case 15:
                                    if (!(commands[_i].constructor === String)) {
                                      _context2.next = 18;
                                      break;
                                    }

                                    _context2.next = 18;
                                    return toolkit.execPromise(commands[_i], { log: true });
